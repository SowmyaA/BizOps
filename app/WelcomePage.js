...
(function () {
    ...
    app.controller('WelcomePage', ['$scope', '$http', function ($scope, $http) {
        $scope.division = null;
        $scope.quarterlyData = null;
        $scope.data = null;
        //Get json data
        $http.get("/data/ProductSummary.js")
    ...
    .error(function (data, status, headers, config) {
        ...
        function dashboard(id, fData) {
            var barColor = '#4682b4';
            function segColor(c) { return { SYMMETRIX: "#807dba", CLARIION: "#e08214", UNIFIED: "#41ab5d", XTREMIO: "#800080", CONNECTRIX: "#FF8000"}[c]; }

            // compute total for each state.
            fData.forEach(function (d) { d.total = d.freq.SYMMETRIX + d.freq.CLARIION + d.freq.UNIFIED + d.freq.XTREMIO + d.freq.CONNECTRIX; });
               ...
               // .on("mouseout", mouseout); // mouseout is defined below.
                ...
                grouped = false;
                    ...
                    .style("fill", function (d, i) {
                        var color = "#807dba";
                        if (i == 0) color = "#807dba"; else if (i == 1) color = "#41ab5d"; else if (i == 2) color = "#e08214"; else if (i == 3) color = "#800080"; else if (i == 4) color = "#FF8000";
                        return color;
                    });
            ...
            var tF = ['SYMMETRIX', 'CLARIION', 'UNIFIED', 'XTREMIO', 'CONNECTRIX'].map(function (d) {
        ...
        var freqData = [
    { State: 'AMERICAS', freq: { SYMMETRIX: 92446, CLARIION: 55969, UNIFIED: 83784, XTREMIO: 11524, CONNECTRIX: 8625} }
    , { State: 'APJ', freq: { SYMMETRIX: 3228, CLARIION: 2624, UNIFIED: 26556, XTREMIO: 76, CONNECTRIX: 0} }
    , { State: 'EMEA', freq: { SYMMETRIX: 5295, CLARIION: 1220, UNIFIED: 1457, XTREMIO: 294, CONNECTRIX: 30} }

    ];

        dashboard('#ProductSummary_dashboard', freqData);
        ...
        $scope.download = function () {
            ...
            html2canvas(document.getElementById('productSummaryDIV'), {
